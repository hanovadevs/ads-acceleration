    ...
    <section className="py-16 sm:py-20 bg-white border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <FadeInWhenVisible className="lg:col-span-5 flex flex-col gap-2.5">
            {TABS.map((tab) => {
              const Icon = tab.icon;
              ...
              return (
                <motion.button
                  ...
                  whileTap={{ scale: 0.99 }}
                  className={`w-full text-left p-5 rounded-2xl border transition-all duration-200 cursor-pointer relative overflow-hidden ${
                    isActive
                      ? 'bg-[#17253F] text-white border-[#17253F] shadow-lg'
                      : 'bg-slate-50 text-slate-800 border-slate-200 hover:bg-slate-100'
                  }`}
                >
                  <div className="flex items-center gap-3.5 relative z-10">
                    <div className={`w-9 h-9 rounded-xl flex items-center justify-center ${
                      isActive ? 'bg-slate-900 text-[#D99B26]' : 'bg-white text-slate-700 border border-slate-200'
                    }`}>
                      <Icon className="w-4 h-4" />
                    </div>
                    <div>
                      <div className={`font-bold text-sm sm:text-base ${isActive ? 'text-white' : 'text-[#17253F]'}`}>
                        {tab.name}
                      </div>
            ...
            <div className="mt-3 pt-3 text-center">
              <Link 
                to="/tools" 
                className="inline-flex items-center gap-2 text-xs font-bold text-[#17253F] hover:text-[#D99B26] transition-colors"
              >
          ...
          <FadeInWhenVisible delay={0.2} className="lg:col-span-7 bg-[#17253F] text-white rounded-3xl p-6 sm:p-8 border border-slate-800 shadow-xl min-h-[420px] flex flex-col justify-between">
            
            {/* Top Bar of Preview */}
            <div>
              <div className="flex items-center justify-between pb-5 border-b border-slate-800 mb-5">
                <div>
                  <h3 className="text-lg sm:text-xl font-bold text-white">{activeTab.name}</h3>
                  <p className="text-xs text-slate-400 mt-0.5 max-w-md">{activeTab.desc}</p>
                </div>
                <Link
                  to={activeTab.link}
                  className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-[#D99B26] hover:bg-yellow-400 text-slate-950 font-bold text-xs transition-colors shrink-0 shadow-md"
                >
                ...
                >
                  {activeTabId === 'ngram' && (
                    <div className="overflow-x-auto">
                      <div className="text-[10px] font-semibold uppercase text-slate-400 tracking-wider mb-2">Live N-Gram Frequency Sample</div>
                      <table className="w-full text-left text-xs text-slate-300">
                        ...
                        <tbody className="divide-y divide-slate-800/60">
                          <tr>
                            <td className="py-2 font-bold text-white">protein powder</td>
                            <td>14,820</td>
                            <td>312</td>
                            <td>$187</td>
                          ...
                          <tr>
                            <td className="py-2 font-bold text-white">whey protein</td>
                            <td>9,440</td>
                            <td>198</td>
                            <td>$143</td>
                          ...
                          <tr>
                            <td className="py-2 font-bold text-white">vanilla protein</td>
                            <td>6,210</td>
                            <td>89</td>
                            <td>$212</td>
                          ...
                          <tr>
                            <td className="py-2 font-bold text-white">5lb protein</td>
                            <td>4,870</td>
                            <td>201</td>
                            <td>$96</td>
                          ...
                          <tr>
                            <td className="py-2 font-bold text-white">keto protein</td>
                            <td>3,120</td>
                            <td>44</td>
                            <td>$167</td>
                    ...
                    <div className="space-y-3">
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-slate-900 p-3.5 rounded-xl border border-slate-800">
                          <div className="text-[11px] text-slate-400">Branded Share</div>
                          <div className="text-xl font-black text-white mt-0.5">68%</div>
                        </div>
                        <div className="bg-slate-900 p-3.5 rounded-xl border border-slate-800">
                          <div className="text-[11px] text-slate-400">Non-Branded Share</div>
                          <div className="text-xl font-black text-[#D99B26] mt-0.5">32%</div>
                        </div>
                      </div>
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-slate-900 p-3.5 rounded-xl border border-slate-800">
                          <div className="text-[11px] text-slate-400">Your Click Share</div>
                          <div className="text-lg font-bold text-white mt-0.5">41%</div>
                        </div>
                        <div className="bg-slate-900 p-3.5 rounded-xl border border-slate-800">
                          <div className="text-[11px] text-slate-400">Competitor Click Share</div>
                          <div className="text-lg font-bold text-rose-400 mt-0.5">59%</div>
                        </div>
                      </div>
                      <div className="p-3 bg-amber-500/10 border border-amber-500/30 rounded-xl text-[#D99B26] text-xs">
                  ...
                  {activeTabId === 'graduation' && (
                    <div className="space-y-2.5">
                      <div className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider">Search Terms Ready To Graduate To Exact</div>
                      {[
                        ...
                        <div key={i} className="flex items-center justify-between bg-slate-900 p-2.5 rounded-xl border border-slate-800">
                          ...
                          <span className={`px-2.5 py-0.5 rounded-lg text-[10px] font-bold ${
                            row.status === 'Ready' ? 'bg-[#D99B26] text-slate-950' : 'bg-slate-800 text-slate-300'
                          }`}>
                  ...
                  {activeTabId === 'cannibalization' && (
                    <div className="space-y-3">
                      <div className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider">Bidding Overlap Conflicts Detected</div>
                      <div className="space-y-2">
                        ...
                        <div className="bg-slate-900 p-3 rounded-xl border border-slate-800 flex items-center justify-between text-xs">
                          ...
                          <span className="text-[#D99B26] font-bold">$18/mo Waste</span>
                        </div>
                      </div>
                      <div className="p-2.5 bg-slate-900 rounded-xl border border-slate-800 flex items-center justify-between text-xs text-slate-300">
                        <span>Total Estimated Monthly Waste:</span>
                        <strong className="text-rose-400 text-xs sm:text-sm">$92/mo</strong>
                      </div>
                    </div>
                  )}
                </motion.div>
            ...
            <div className="pt-3 border-t border-slate-800 flex items-center justify-between text-[11px] text-slate-400">
              ...
              <span className="text-[#D99B26] font-bold">No Credit Card Needed</span>
            </div>
